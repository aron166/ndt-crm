...
export const UI = {
  ...
  approvalsTwo: "Két bíráló kell",
  approvalsOne: "Egy bíráló elég",
  approvalsBlocked: "Két bíráló kell, de csak egy van beállítva, ezért ez nem mehet élesbe.",
  approvalsCount: (n: number, required: number) => `${n} / ${required} jóváhagyás`,
  approvalsSettings: "Hány jóváhagyás kell?",
  approvalsWarning: "Ha egy vevőnek szóló kategóriát egy bírálóra állítasz, elveszik a négy szem elve.",
