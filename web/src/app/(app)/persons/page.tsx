            ...
            return (
              ...
              >
                ...
                <td style={{ padding: "7px 14px", borderBottom: "1px solid var(--line-soft)" }}>
                  <Link href={`/persons/${p.id}`} className="tbl-link" style={{ fontSize: 13 }}>
                    {p.lastName} {p.firstName}
                  </Link>
                  {currentContact?.role && (
                    <span style={{ fontSize: 11, color: "var(--fg-faint)", marginLeft: 8 }}>
                      {currentContact.role}
                    </span>
                  )}
                </td>
                ...
                <td style={{ padding: "7px 14px", borderBottom: "1px solid var(--line-soft)" }}>
                  {currentContact ? (
                    <Link href={`/companies/${currentContact.company.id}`} className="tbl-link-muted" style={{ fontSize: 12 }}>
